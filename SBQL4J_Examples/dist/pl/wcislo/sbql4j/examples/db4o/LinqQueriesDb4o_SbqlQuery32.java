...
public class LinqQueriesDb4o_SbqlQuery32 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery32(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.(Product order by (category, unitPrice DESC ))'
    */
    public java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery() {
        ...
        java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery32Db4o0());
