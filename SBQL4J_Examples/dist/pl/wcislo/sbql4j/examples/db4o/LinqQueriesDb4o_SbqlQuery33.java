...
public class LinqQueriesDb4o_SbqlQuery33 {
     ...
     *
     * query after optimization='db.(words as w order by (w.length(), w using comp))'
    */
    public java.util.List<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_db = db;
        java.util.List<java.lang.String> _queryResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery33Db4o0(
                    words, comp));
