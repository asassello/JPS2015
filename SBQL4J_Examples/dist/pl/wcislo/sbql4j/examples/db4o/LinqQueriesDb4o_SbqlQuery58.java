...
public class LinqQueriesDb4o_SbqlQuery58 {
    private List<java.lang.Integer> numbers;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery58(final int[] numbers,
     ...
     *
     * query after optimization='( sum numbers group as _aux0).db._aux0'
    */
    public java.lang.Integer executeQuery() {
        java.util.List<java.lang.Integer> _ident_numbers = numbers;
        Number _sum0 = null;

        for (Number _sumEl0 : _ident_numbers) {
        ...
        java.lang.Integer _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery58Db4o0(
                    _groupAsResult_aux0));
