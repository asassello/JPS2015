...
public class LinqQueriesDb4o_SbqlQuery39Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery39Db4o0() {
    }

    /**
     * query='db.( unique Product.category)'
    '
     **/
    public java.util.Collection<java.lang.String> executeQuery(
        ...
        for (long _id18 : _ids18) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref18.getObject());
        }
