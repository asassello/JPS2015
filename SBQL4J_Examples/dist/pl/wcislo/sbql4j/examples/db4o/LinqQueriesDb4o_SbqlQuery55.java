...
public class LinqQueriesDb4o_SbqlQuery55 {
    private List<java.lang.Integer> numbers;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery55(final int[] numbers,
     ...
     *
     * query after optimization='( count((numbers as n where n % 2 == 1)) group as _aux0).db._aux0'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery55Db4o0(
                    _groupAsResult_aux0));
