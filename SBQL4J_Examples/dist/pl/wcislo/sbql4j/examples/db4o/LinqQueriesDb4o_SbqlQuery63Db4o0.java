...
public class LinqQueriesDb4o_SbqlQuery63Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery63Db4o0() {
    }

    /**
     * query='db.( unique Product.category as cat).(cat as category,  min((Product where category == cat).unitPrice) as cheapestPrice)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id35 : _ids35) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref35.getObject());
        }
        ...
        for (java.lang.String _dotEl2 : _asResult_cat) {
            ...
            for (long _id36 : _ids36) {
                ...
                _ident_Product1.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref36.getObject());
            }
