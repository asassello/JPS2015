...
public class LinqQueriesDb4o_SbqlQuery10 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery10(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.Product.(productName as productName, category as category, unitPrice as price)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery10Db4o0());
