...
public class LinqQueriesDb4o_SbqlQuery57Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery57Db4o0() {
    }

    /**
     * query='db.( unique Product.category as cat).(cat as category,  count((Product where category == cat)) as productCount)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id31 : _ids31) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref31.getObject());
        }
        ...
        for (java.lang.String _dotEl1 : _asResult_cat) {
            ...
            for (long _id32 : _ids32) {
                ...
                _ident_Product1.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref32.getObject());
            }
