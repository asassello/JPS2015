...
public class Db4oSimpleTest_SbqlQuery0 {
    private com.db4o.ObjectContainer db;

    public Db4oSimpleTest_SbqlQuery0(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(Product)'
     *
     * query after optimization='db.Product'
    */
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> _queryResult =
            _ident_db.query(new Db4oSimpleTest_SbqlQuery0Db4o0());
