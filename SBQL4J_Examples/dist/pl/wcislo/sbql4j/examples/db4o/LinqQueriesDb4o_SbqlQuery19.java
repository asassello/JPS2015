...
public class LinqQueriesDb4o_SbqlQuery19 {
    private List<java.lang.Integer> numbers;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery19(final int[] numbers,
    ...
    /**
     * original query='db.(numbers[0..2])'
     *
     * query after optimization='(numbers[0..2] group as _aux0).db._aux0'
    */
    public java.util.List<java.lang.Integer> executeQuery() {
        ...
        if (!_ident_numbers.isEmpty()) {
            ...
            Integer _lowBound0 = 0;
            Integer _upBound0 = 2;

            if (_upBound0 >= _ident_numbers.size()) {
                _upBound0 = _ident_numbers.size() - 2;
            }

            _element_atResult = _ident_numbers.subList(_lowBound0, _upBound0 +
                    1);
        }
        ...
        java.util.List<java.lang.Integer> _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery19Db4o0(
                    _groupAsResult_aux0));
