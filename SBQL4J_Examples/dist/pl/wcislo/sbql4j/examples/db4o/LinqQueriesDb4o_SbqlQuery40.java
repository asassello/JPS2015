...
public class LinqQueriesDb4o_SbqlQuery40 {
     ...
     *
     * query after optimization='( unique (numbersA union numbersB) group as _aux0).db._aux0'
    */
    public java.util.List<java.lang.Integer> executeQuery() {
        ...
        Set<java.lang.Integer> _tmp7 = new LinkedHashSet<java.lang.Integer>();
        _tmp7.addAll(_unionResult);
        _uniqueResult.addAll(_tmp7);
        ...
        java.util.List<java.lang.Integer> _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery40Db4o0(
                    _groupAsResult_aux0));
