...
public class LinqQueriesDb4o_SbqlQuery49 {
    private List<java.lang.Integer> numbers;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery49(final int[] numbers,
     ...
     *
     * query after optimization='((numbers as n where n > 5)[1] group as _aux0).db._aux0'
    */
    public java.lang.Integer executeQuery() {
        ...
        if (!_whereResult.isEmpty()) {
            _element_atResult = _whereResult.get(1);
        }

        java.lang.Integer _groupAsResult_aux0 = _element_atResult;
        java.lang.Integer _dotEl1 = _groupAsResult_aux0;
        com.db4o.ObjectContainer _ident_db = db;
        java.lang.Integer _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery49Db4o0(
                    _groupAsResult_aux0));
