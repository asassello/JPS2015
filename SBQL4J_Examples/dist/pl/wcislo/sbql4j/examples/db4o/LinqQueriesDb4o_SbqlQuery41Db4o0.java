...
public class LinqQueriesDb4o_SbqlQuery41Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery41Db4o0() {
    }

    /**
     * query='db.( unique (Product.productName.charAt(0) union Customer.companyName.charAt(0)))'
    '
     **/
    public java.util.Collection<java.lang.Character> executeQuery(
        ...
        for (long _id19 : _ids19) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref19.getObject());
        }
        ...
        for (long _id20 : _ids20) {
            ...
            _ident_Customer.add((pl.wcislo.sbql4j.examples.model.linq.Customer) _ref20.getObject());
        }
        ...
        java.util.Collection<java.lang.Character> _unionResult = new java.util.ArrayList<java.lang.Character>();
        _unionResult.addAll(_dotResult1);
        _unionResult.addAll(_dotResult3);

        java.util.Collection<java.lang.Character> _uniqueResult = new java.util.ArrayList<java.lang.Character>();
        Set<java.lang.Character> _tmp8 = new LinkedHashSet<java.lang.Character>();
        _tmp8.addAll(_unionResult);
        _uniqueResult.addAll(_tmp8);
