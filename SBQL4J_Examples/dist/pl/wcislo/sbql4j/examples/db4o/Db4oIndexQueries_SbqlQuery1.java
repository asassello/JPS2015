...
public class Db4oIndexQueries_SbqlQuery1 {
    private com.db4o.ObjectContainer db;

    public Db4oIndexQueries_SbqlQuery1(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(Product where productName == "Ikura")'
     *
     * query after optimization='db.Product_ByIndex[productName]("Ikura")'
    */
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> _queryResult =
            _ident_db.query(new Db4oIndexQueries_SbqlQuery1Db4o0());
