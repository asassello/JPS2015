...
public class ADBIS_SbqlQuery0Db4o1 implements Db4oSBQLQuery {
    private java.lang.Double minSalary;

    public ADBIS_SbqlQuery0Db4o1(java.lang.Double minSalary) {
        this.minSalary = minSalary;
    }

    /**
     * query='db2.(Employee where getSalary() > minSalary)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.advanced.Employee> executeQuery(
        ...
        for (long _id1 : _ids1) {
            ...
            _ident_Employee1.add((pl.wcislo.sbql4j.examples.model.advanced.Employee) _ref1.getObject());
        }
        ...
        for (pl.wcislo.sbql4j.examples.model.advanced.Employee _whereEl1 : _ident_Employee1) {
            ...
            java.lang.Double _ident_minSalary = minSalary;

            Boolean _moreResult1 = (_mth_getSalaryResult1 == null)
                ? ((_mth_getSalaryResult1 == null) ? false : false)
                : ((_mth_getSalaryResult1 == null) ? true
                                                   : (_mth_getSalaryResult1 > _ident_minSalary));
