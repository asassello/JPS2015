...
public class ADBIS_SbqlQuery0Db4o0 implements Db4oSBQLQuery {
    private java.lang.Double _groupAsResult_aux0;

    public ADBIS_SbqlQuery0Db4o0(java.lang.Double _groupAsResult_aux0) {
        this._groupAsResult_aux0 = _groupAsResult_aux0;
    }

    /**
     * query='db1.(Employee where getSalary() > _aux0)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.advanced.Employee> executeQuery(
        ...
        for (long _id0 : _ids0) {
            ...
            _ident_Employee.add((pl.wcislo.sbql4j.examples.model.advanced.Employee) _ref0.getObject());
        }
        ...
        for (pl.wcislo.sbql4j.examples.model.advanced.Employee _whereEl : _ident_Employee) {
            ...
            java.lang.Double _ident__aux0 = _groupAsResult_aux0;

            Boolean _moreResult = (_mth_getSalaryResult == null)
                ? ((_mth_getSalaryResult == null) ? false : false)
                : ((_mth_getSalaryResult == null) ? true
                                                  : (_mth_getSalaryResult > _ident__aux0));
