...
public class AdvancedQueriesDb4o_SbqlQuery0 {
    private com.db4o.ObjectContainer db;

    public AdvancedQueriesDb4o_SbqlQuery0(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(Department join avg(employs.salary))'
     *
     * query after optimization='db.(Department join  avg(getEmploys().getSalary()))'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new AdvancedQueriesDb4o_SbqlQuery0Db4o0());
