...
public class AdvancedQueriesDb4o_SbqlQuery9 {
    private com.db4o.ObjectContainer db;

    public AdvancedQueriesDb4o_SbqlQuery9(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.( unique Department.getLocation() as deptcity where  all Department deptcity in getLocation())'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_db = db;
        java.util.Collection<java.lang.String> _queryResult = _ident_db.query(new AdvancedQueriesDb4o_SbqlQuery9Db4o0());
