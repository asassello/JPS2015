...
public class AdvancedQueriesDb4o_SbqlQuery4 {
    private com.db4o.ObjectContainer db;

    public AdvancedQueriesDb4o_SbqlQuery4(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.(Department where getBoss().getName() == "Bert").getEmploys().(getName(), ( exists getAddress() ? getAddress().getCity() : "No address"))'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new AdvancedQueriesDb4o_SbqlQuery4Db4o0());
