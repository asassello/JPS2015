...
public class AdvancedQueriesDb4o_SbqlQuery6 {
    private com.db4o.ObjectContainer db;

    public AdvancedQueriesDb4o_SbqlQuery6(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(((Department as d) join ((sum(d.employs.salary) - (d.boss.salary)) as s)).(d.name, s))'
     *
     * query after optimization='db.(Department as d join ( sum d.getEmploys().getSalary() - d.getBoss().getSalary()) as s).(d.getName(), s)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new AdvancedQueriesDb4o_SbqlQuery6Db4o0());
