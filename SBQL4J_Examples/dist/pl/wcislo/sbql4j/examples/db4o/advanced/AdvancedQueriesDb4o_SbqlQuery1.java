...
public class AdvancedQueriesDb4o_SbqlQuery1 {
    private com.db4o.ObjectContainer db;

    public AdvancedQueriesDb4o_SbqlQuery1(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.((Employee where salary < 2222).(name, salary, worksIn.name))'
     *
     * query after optimization='db.(Employee where getSalary() < 2222).(getName(), getSalary(), getWorksIn().getName())'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new AdvancedQueriesDb4o_SbqlQuery1Db4o0());
