...
public class LinqQueriesDb4o_SbqlQuery33Db4o0 implements Db4oSBQLQuery {
    private java.util.List<java.lang.String> words;
    private java.util.Comparator comp;

    public LinqQueriesDb4o_SbqlQuery33Db4o0(
    ...
    public java.util.List<java.lang.String> executeQuery(
        ...
        Collections.sort(_orderByResult, _comparator10);
