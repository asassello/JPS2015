...
public class LinqQueriesDb4o_SbqlQuery51 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery51(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.(( unique Product.category as cat).(cat as category, (Product where category == cat) group as products) where  any products unitsInStock == 0)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery51Db4o0());
