...
public class LinqQueriesDb4o_SbqlQuery4 {
    private List<java.lang.String> digits;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery4(final java.lang.String[] digits,
    ...
    /**
     * original query='db.(digits where length() < $index)'
     *
     * query after optimization='((digits where length() < $index) group as _aux0).db._aux0'
    */
    public java.util.List<java.lang.String> executeQuery() {
        ...
        java.util.List<java.lang.String> _groupAsResult_aux0 = _whereResult;
        java.util.List<java.lang.String> _dotEl1 = _groupAsResult_aux0;
        com.db4o.ObjectContainer _ident_db = db;
        java.util.List<java.lang.String> _dotResult = _ident_db.query(new LinqQueriesDb4o_SbqlQuery4Db4o0(
                    _groupAsResult_aux0));
