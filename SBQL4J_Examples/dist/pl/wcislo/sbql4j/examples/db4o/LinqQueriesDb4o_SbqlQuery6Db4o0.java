...
public class LinqQueriesDb4o_SbqlQuery6Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery6Db4o0() {
    }

    /**
     * query='db.Product.productName'
    '
     **/
    public java.util.Collection<java.lang.String> executeQuery(
        ...
        for (long _id3 : _ids3) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref3.getObject());
        }
