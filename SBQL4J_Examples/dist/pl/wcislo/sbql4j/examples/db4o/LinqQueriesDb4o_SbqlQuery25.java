...
public class LinqQueriesDb4o_SbqlQuery25 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery25(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.(Product as p order by (p.productName))'
    */
    public java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery() {
        ...
        java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery25Db4o0());
