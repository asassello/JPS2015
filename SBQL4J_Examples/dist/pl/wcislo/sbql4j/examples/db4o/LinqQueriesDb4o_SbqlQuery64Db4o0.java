...
public class LinqQueriesDb4o_SbqlQuery64Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery64Db4o0() {
    }

    /**
     * query='db.( unique Product.category as cat).(cat as cat, (Product where category == cat) group as pr).(cat as category, ( min(pr.unitPrice) group as _aux0).(pr where unitPrice == _aux0) group as cheapestProducts)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id37 : _ids37) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref37.getObject());
        }
        ...
        for (java.lang.String _dotEl1 : _asResult_cat) {
            ...
            for (long _id38 : _ids38) {
                ...
                _ident_Product1.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref38.getObject());
            }
        ...
        for (pl.wcislo.sbql4j.java.model.runtime.Struct _dotEl4 : _dotResult1) {
            ...
            java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> _groupAsResultcheapestProducts =
                _whereResult1;
