...
public class LinqQueriesDb4o_SbqlQuery1 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery1(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(Product where unitsInStock == 0)'
     *
     * query after optimization='db.(Product where unitsInStock == 0)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery1Db4o0());
