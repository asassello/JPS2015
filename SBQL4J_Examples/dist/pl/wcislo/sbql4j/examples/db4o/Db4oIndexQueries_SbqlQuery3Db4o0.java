...
public class Db4oIndexQueries_SbqlQuery3Db4o0 implements Db4oSBQLQuery {
    public Db4oIndexQueries_SbqlQuery3Db4o0() {
    }

    /**
     * query='db.(Product_ByIndex[productName]("Ikura") where unitsInStock > 0 and unitPrice < 1000)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.examples.model.linq.Product> executeQuery(
        ...
        FieldMetadata _fieldMeta3 = _classMeta3.fieldMetadataForName(
                "productName");
        BTreeRange _range3 = _fieldMeta3.search(t, "Ikura");
        Iterator4 _it3 = _range3.pointers();

        while (_it3.moveNext()) {
            BTreePointer _point3 = (BTreePointer) _it3.current();
            FieldIndexKeyImpl _pointKey3 = (FieldIndexKeyImpl) _point3.key();
            int _id3 = _pointKey3.parentID();
            LazyObjectReference _ref3 = transLocal.lazyReferenceFor(_id3);
            pl.wcislo.sbql4j.examples.model.linq.Product _obj3 = (pl.wcislo.sbql4j.examples.model.linq.Product) _ref3.getObject();

            if (_obj3 != null) {
                ocb.activate(_obj3);
            }

            _ident_Product.add(_obj3);
        }
        ...
        for (pl.wcislo.sbql4j.examples.model.linq.Product _whereEl : _ident_Product) {
            ...
            if (!_moreResult) {
                ...
                Boolean _lessResult = _ident_unitPrice < 1000;
