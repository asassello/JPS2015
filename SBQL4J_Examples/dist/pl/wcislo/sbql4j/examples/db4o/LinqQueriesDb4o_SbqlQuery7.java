...
public class LinqQueriesDb4o_SbqlQuery7 {
    private List<java.lang.Integer> numbers;
    private List<java.lang.String> strings;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery7(final int[] numbers,
        final java.lang.String[] strings, final com.db4o.ObjectContainer db) {
     ...
     *
     * query after optimization='((numbers as n).(strings[n]) group as _aux0).db._aux0'
    */
    public java.util.List<java.lang.String> executeQuery() {
        ...
        for (java.lang.Integer _dotEl : _asResult_n) {
            ...
            _dotResult.add(_element_atResult);
            _dotIndex++;
        }

        java.util.List<java.lang.String> _groupAsResult_aux0 = _dotResult;
        java.util.List<java.lang.String> _dotEl2 = _groupAsResult_aux0;
        com.db4o.ObjectContainer _ident_db = db;
        java.util.List<java.lang.String> _dotResult1 = _ident_db.query(new LinqQueriesDb4o_SbqlQuery7Db4o0(
                    _groupAsResult_aux0));
