...
public class LinqQueriesDb4o_SbqlQuery62 {
    private List<java.lang.String> words;
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery62(final java.lang.String[] words,
     ...
     *
     * query after optimization='( min(words.length()) group as _aux0).db._aux0'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _dotResult1 = _ident_db.query(new LinqQueriesDb4o_SbqlQuery62Db4o0(
                    _groupAsResult_aux0));
