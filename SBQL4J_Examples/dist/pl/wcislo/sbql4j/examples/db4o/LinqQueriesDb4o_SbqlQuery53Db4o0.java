...
public class LinqQueriesDb4o_SbqlQuery53Db4o0 implements Db4oSBQLQuery {
    public LinqQueriesDb4o_SbqlQuery53Db4o0() {
    }

    /**
     * query='db.(( unique Product.category as cat).(cat as category, (Product where category == cat) group as products) where  all products unitsInStock > 0)'
    '
     **/
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery(
        ...
        for (long _id28 : _ids28) {
            ...
            _ident_Product.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref28.getObject());
        }
        ...
        Set<java.lang.String> _tmp13 = new LinkedHashSet<java.lang.String>();
        _tmp13.addAll(_dotResult);
        _uniqueResult.addAll(_tmp13);
        ...
        for (java.lang.String _dotEl1 : _asResult_cat) {
            ...
            for (long _id29 : _ids29) {
                ...
                _ident_Product1.add((pl.wcislo.sbql4j.examples.model.linq.Product) _ref29.getObject());
            }
        ...
        for (pl.wcislo.sbql4j.java.model.runtime.Struct _whereEl1 : _dotResult1) {
            ...
            for (pl.wcislo.sbql4j.examples.model.linq.Product _allEl : _ident_products) {
                if (_allEl != null) {
                    ocb.activate(_allEl, 1);
                }

                java.lang.Integer _ident_unitsInStock = ((_allEl == null)
                    ? null : _allEl.unitsInStock);
