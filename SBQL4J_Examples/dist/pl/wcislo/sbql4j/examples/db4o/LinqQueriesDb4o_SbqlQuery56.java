...
public class LinqQueriesDb4o_SbqlQuery56 {
    private com.db4o.ObjectContainer db;

    public LinqQueriesDb4o_SbqlQuery56(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='db.(Customer as c).(c.customerID as customerID,  count(c.orders) as orderCount)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_db.query(new LinqQueriesDb4o_SbqlQuery56Db4o0());
