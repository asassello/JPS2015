...
public class OperatorExamples_SbqlQuery1 {
    private List<java.lang.Integer> numbers;

    public OperatorExamples_SbqlQuery1(final int[] numbers) {
     ...
     *
     * query after optimization='(numbers as n).(n as n, (n % 2 == 1 ? "odd" : "even"))'
    */
    public java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        for (java.lang.Integer _dotEl : _asResult_n) {
            ...
            java.lang.Integer _asResult_n1 = _ident_n;
            ...
            pl.wcislo.sbql4j.java.model.runtime.Struct _commaResult = OperatorUtils.cartesianProductSS(_asResult_n1,
                    _conditionalResult, "n", "");
