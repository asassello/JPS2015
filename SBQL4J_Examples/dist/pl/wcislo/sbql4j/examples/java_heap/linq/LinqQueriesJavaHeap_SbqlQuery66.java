...
public class LinqQueriesJavaHeap_SbqlQuery66 {
    private List<java.lang.String> words;

    public LinqQueriesJavaHeap_SbqlQuery66(final java.lang.String[] words) {
        this.words = ArrayUtils.toList(words);
    }

    /**
     * original query='max(words.length())'
     *
     * query after optimization=' max(words.length())'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = (java.lang.Integer) _max1;
