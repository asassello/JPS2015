...
public class LinqQueriesJavaHeap_SbqlQuery41 {
    ...
    public LinqQueriesJavaHeap_SbqlQuery41(
    ...
    /**
     * original query='unique(
                            products.productName.charAt(0)
                            union
                            customers.companyName.charAt(0)
                    )'
     *
     * query after optimization=' unique (products.productName.charAt(0) union customers.companyName.charAt(0))'
    */
    public java.util.List<java.lang.Character> executeQuery() {
        ...
        java.util.List<java.lang.Character> _unionResult = new java.util.ArrayList<java.lang.Character>();
        _unionResult.addAll(_dotResult1);
        _unionResult.addAll(_dotResult3);

        java.util.List<java.lang.Character> _queryResult = new java.util.ArrayList<java.lang.Character>();
        Set<java.lang.Character> _tmp8 = new LinkedHashSet<java.lang.Character>();
        _tmp8.addAll(_unionResult);
        _queryResult.addAll(_tmp8);
