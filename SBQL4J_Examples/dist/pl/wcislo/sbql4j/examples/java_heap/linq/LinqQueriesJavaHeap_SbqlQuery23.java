...
public class LinqQueriesJavaHeap_SbqlQuery23 {
    private List<java.lang.String> words;

    public LinqQueriesJavaHeap_SbqlQuery23(final java.lang.String[] words) {
        this.words = ArrayUtils.toList(words);
    }

    /**
     * original query='words as w order by w'
     *
     * query after optimization='words as w order by (w)'
    */
    public java.util.List<java.lang.String> executeQuery() {
        ...
        Comparator<java.lang.String> _comparator0 = new Comparator<java.lang.String>() {
