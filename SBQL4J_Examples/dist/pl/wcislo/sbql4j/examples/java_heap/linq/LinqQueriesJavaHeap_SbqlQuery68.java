...
public class LinqQueriesJavaHeap_SbqlQuery68 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery68(
     ...
     *
     * query after optimization='( unique products.category as cat).(cat as cat, (products where category == cat) group as pr).(cat as category, ( max(pr.unitPrice) group as _aux0).(pr where unitPrice == _aux0) group as mostExpensiveProducts)'
    */
    public java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        for (pl.wcislo.sbql4j.java.model.runtime.Struct _dotEl4 : _dotResult1) {
            ...
            java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> _groupAsResultmostExpensiveProducts =
                _whereResult1;
