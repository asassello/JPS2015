...
public class LinqQueriesJavaHeap_SbqlQuery50 {
    private List<java.lang.String> words;

    public LinqQueriesJavaHeap_SbqlQuery50(final java.lang.String[] words) {
        this.words = ArrayUtils.toList(words);
    }

    /**
     * original query='any words contains("ei")'
     *
     * query after optimization=' any words contains("ei")'
    */
    public java.lang.Boolean executeQuery() {
        java.util.List<java.lang.String> _ident_words = words;
        java.lang.Boolean _queryResult = false;
        Integer _anyIndex = 0;
