...
public class LinqQueriesJavaHeap_SbqlQuery42 {
    private List<java.lang.Integer> numbersA;
    private List<java.lang.Integer> numbersB;

    public LinqQueriesJavaHeap_SbqlQuery42(final int[] numbersA,
        final int[] numbersB) {
    ...
    /**
     * original query='numbersA intersect numbersB'
     *
     * query after optimization='numbersA intersect numbersB'
    */
    public java.util.List<java.lang.Integer> executeQuery() {
        ...
        _queryResult.addAll(CollectionUtils.intersection(_minusLeftCol0,
                _minusRightCol0));
