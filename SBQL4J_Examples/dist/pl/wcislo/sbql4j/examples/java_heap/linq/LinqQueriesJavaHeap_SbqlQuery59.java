...
public class LinqQueriesJavaHeap_SbqlQuery59 {
    private List<java.lang.String> words;

    public LinqQueriesJavaHeap_SbqlQuery59(final java.lang.String[] words) {
        this.words = ArrayUtils.toList(words);
    }

    /**
     * original query='sum(words.length())'
     *
     * query after optimization=' sum words.length()'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = (java.lang.Integer) _sum1;
