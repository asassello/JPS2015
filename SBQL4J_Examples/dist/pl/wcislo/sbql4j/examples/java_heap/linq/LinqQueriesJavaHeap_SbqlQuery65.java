...
public class LinqQueriesJavaHeap_SbqlQuery65 {
    private List<java.lang.Integer> numbers;

    public LinqQueriesJavaHeap_SbqlQuery65(final int[] numbers) {
        this.numbers = ArrayUtils.toList(numbers);
    }

    /**
     * original query='max(numbers)'
     *
     * query after optimization=' max(numbers)'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = (java.lang.Integer) _max0;
