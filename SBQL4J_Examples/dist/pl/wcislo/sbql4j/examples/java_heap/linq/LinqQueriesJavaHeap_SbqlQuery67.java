...
public class LinqQueriesJavaHeap_SbqlQuery67 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery67(
     ...
     *
     * query after optimization='( unique products.category as cat).(cat as category,  max((products where category == cat).unitPrice) as mostExpensivePrice)'
    */
