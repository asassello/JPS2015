...
public class LinqQueriesJavaHeap_SbqlQuery58 {
    private List<java.lang.Integer> numbers;

    public LinqQueriesJavaHeap_SbqlQuery58(final int[] numbers) {
        this.numbers = ArrayUtils.toList(numbers);
    }

    /**
     * original query='sum(numbers)'
     *
     * query after optimization=' sum numbers'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = (java.lang.Integer) _sum0;
