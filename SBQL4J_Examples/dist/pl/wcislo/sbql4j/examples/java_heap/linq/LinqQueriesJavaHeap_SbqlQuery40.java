...
public class LinqQueriesJavaHeap_SbqlQuery40 {
    private List<java.lang.Integer> numbersA;
    private List<java.lang.Integer> numbersB;

    public LinqQueriesJavaHeap_SbqlQuery40(final int[] numbersA,
        final int[] numbersB) {
    ...
    /**
     * original query='unique(numbersA union numbersB)'
     *
     * query after optimization=' unique (numbersA union numbersB)'
    */
