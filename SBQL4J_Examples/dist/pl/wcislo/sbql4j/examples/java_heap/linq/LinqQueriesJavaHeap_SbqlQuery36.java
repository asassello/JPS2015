...
public class LinqQueriesJavaHeap_SbqlQuery36 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery36(
        final java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products) {
        this.products = products;
    }

    /**
     * original query='(unique(products.category) as c).
                    (c as category, (products where category == c) group as products)'
     *
     * query after optimization='( unique products.category as c).(c as category, (products where category == c) group as products)'
    */
    public java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.List<java.lang.String> _asResult_c = _uniqueResult;
