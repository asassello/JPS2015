...
public class LinqQueriesJavaHeap_SbqlQuery71 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery71(
     ...
     *
     * query after optimization='( unique products.category as cat).(cat as category,  avg((products where category == cat).unitPrice) as averagePrice)'
    */
