...
public class LinqQueriesJavaHeap_SbqlQuery19 {
    private List<java.lang.Integer> numbers;

    public LinqQueriesJavaHeap_SbqlQuery19(final int[] numbers) {
        this.numbers = ArrayUtils.toList(numbers);
    }

    /**
     * original query='numbers[0..2]'
     *
     * query after optimization='numbers[0..2]'
    */
    public java.util.List<java.lang.Integer> executeQuery() {
        ...
        if (!_ident_numbers.isEmpty()) {
            ...
            _queryResult = _ident_numbers.subList(_lowBound0, _upBound0 + 1);
        }
