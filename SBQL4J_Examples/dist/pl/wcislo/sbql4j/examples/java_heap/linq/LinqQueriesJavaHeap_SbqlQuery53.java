...
public class LinqQueriesJavaHeap_SbqlQuery53 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery53(
     ...
     *
     * query after optimization='( unique products.category as cat).(cat as category, (products where category == cat) group as products) where  all products unitsInStock > 0'
    */
    public java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        for (pl.wcislo.sbql4j.java.model.runtime.Struct _whereEl1 : _dotResult1) {
            ...
            for (pl.wcislo.sbql4j.examples.model.linq.Product _allEl : _ident_products2) {
