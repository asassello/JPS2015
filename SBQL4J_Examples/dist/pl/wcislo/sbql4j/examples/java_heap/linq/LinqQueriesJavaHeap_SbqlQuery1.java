...
public class LinqQueriesJavaHeap_SbqlQuery1 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery1(
        final java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products) {
        this.products = products;
    }

    /**
     * original query='products where unitsInStock == 0'
     *
     * query after optimization='products where unitsInStock == 0'
    */
