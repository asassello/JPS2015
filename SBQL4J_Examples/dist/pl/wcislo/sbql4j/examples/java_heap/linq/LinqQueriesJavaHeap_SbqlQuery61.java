...
public class LinqQueriesJavaHeap_SbqlQuery61 {
    private List<java.lang.Integer> numbers;

    public LinqQueriesJavaHeap_SbqlQuery61(final int[] numbers) {
        this.numbers = ArrayUtils.toList(numbers);
    }

    /**
     * original query='min(numbers)'
     *
     * query after optimization=' min(numbers)'
    */
    public java.lang.Integer executeQuery() {
        ...
        java.lang.Integer _queryResult = (java.lang.Integer) _min0;
