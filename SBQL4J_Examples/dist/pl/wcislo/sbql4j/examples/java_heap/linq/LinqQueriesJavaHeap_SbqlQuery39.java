...
public class LinqQueriesJavaHeap_SbqlQuery39 {
    private java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products;

    public LinqQueriesJavaHeap_SbqlQuery39(
        final java.util.List<pl.wcislo.sbql4j.examples.model.linq.Product> products) {
        this.products = products;
    }

    /**
     * original query='unique(products.category)'
     *
     * query after optimization=' unique products.category'
    */
    public java.util.List<java.lang.String> executeQuery() {
        ...
        Set<java.lang.String> _tmp6 = new LinkedHashSet<java.lang.String>();
        _tmp6.addAll(_dotResult);
        _queryResult.addAll(_tmp6);
