...
public class XMLExamples_SbqlQuery1 {
    private pl.wcislo.sbql4j.lang.xml.XMLDataSource xmlSource;

    public XMLExamples_SbqlQuery1(
        final pl.wcislo.sbql4j.lang.xml.XMLDataSource xmlSource) {
        this.xmlSource = xmlSource;
    }

    /**
     * original query='xmlSource.catalogue.book'
     *
     * query after optimization='xmlSource.catalogue.book'
    */
    public java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        XMLTypeMapper __typeMapper1 = new XMLTypeMapper(Arrays.asList(
                    ...
                    new XMLTypeMapper.XMLTypeMapperEntry(
                        ...
                        SCollectionType.NO_COLLECTION, false)));
        xmlSource.getParser().setMapper(__typeMapper1);
        ...
        java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> _ident_book = (java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct>) _dotEl1.get(
                "book");
        java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct> _newRes1 = (java.util.List<pl.wcislo.sbql4j.java.model.runtime.Struct>) pl.wcislo.sbql4j.xml.utils.XMLUtils.derefIfNecessary(_ident_book);
