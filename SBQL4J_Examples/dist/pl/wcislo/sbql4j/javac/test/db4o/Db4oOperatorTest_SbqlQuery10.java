...
public class Db4oOperatorTest_SbqlQuery10 {
    private com.db4o.ObjectContainer db;

    public Db4oOperatorTest_SbqlQuery10(final com.db4o.ObjectContainer db) {
        this.db = db;
    }
     ...
     *
     * query after optimization='((( bag1 union 2), 3) group as _aux0).db._aux0'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _dotResult =
            _ident_db.query(new Db4oOperatorTest_SbqlQuery10Db4o0(
                    _groupAsResult_aux0));
