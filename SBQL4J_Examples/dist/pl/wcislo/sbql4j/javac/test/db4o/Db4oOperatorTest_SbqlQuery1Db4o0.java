...
public class Db4oOperatorTest_SbqlQuery1Db4o0 implements Db4oSBQLQuery {
    public Db4oOperatorTest_SbqlQuery1Db4o0() {
    }

    /**
     * query='db.( all Emp isMarried())'
    '
     **/
    public java.lang.Boolean executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id0 : _ids0) {
            ...
            _ident_Emp.add((pl.wcislo.sbql4j.examples.model.Emp) _ref0.getObject());
        }

        java.lang.Boolean _allResult = true;
        Integer _allIndex = 0;

        for (pl.wcislo.sbql4j.examples.model.Emp _allEl : _ident_Emp) {
            if (_allEl != null) {
                ocb.activate(_allEl, 1);
            }

            java.lang.Boolean _mth_isMarriedResult = _allEl.isMarried();
