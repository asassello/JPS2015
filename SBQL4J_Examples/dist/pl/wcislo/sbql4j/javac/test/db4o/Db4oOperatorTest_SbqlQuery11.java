...
public class Db4oOperatorTest_SbqlQuery11 {
    private com.db4o.ObjectContainer db;

    public Db4oOperatorTest_SbqlQuery11(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(bag(1,2),bag(3,4))'
     *
     * query after optimization='((( bag1 union 2), ( bag3 union 4)) group as _aux0).db._aux0'
    */
