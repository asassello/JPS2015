...
public class Db4oOperatorTest_SbqlQuery5 {
    private com.db4o.ObjectContainer db;

    public Db4oOperatorTest_SbqlQuery5(final com.db4o.ObjectContainer db) {
        this.db = db;
    }

    /**
     * original query='db.(bag(1,2))'
     *
     * query after optimization='(( bag1 union 2) group as _aux0).db._aux0'
    */
    public java.util.Collection<java.lang.Integer> executeQuery() {
        ...
        java.util.Collection<java.lang.Integer> _dotResult = _ident_db.query(new Db4oOperatorTest_SbqlQuery5Db4o0(
                    _groupAsResult_aux0));
